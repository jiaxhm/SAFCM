...
ance and revealing intrinsic low-dimensional features. The PCA considers only the
 ...
 differences. To address this limitation, we propose a super spatial perceptive strategy
 to improve classification accuracy. Fig. 1 shows the schematic of super-aware fuzzy c
means clustering (SAFCM) applied to the first three principal components (3 PCs) of
 HSI.
